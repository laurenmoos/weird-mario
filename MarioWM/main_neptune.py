...
neptune.init('jetdillo/sandbox')
#neptune.init(api_token=ANONYMOUS, project_qualified_name='jetdillo/sandbox')
neptune.create_experiment('tensorboard-logging',upload_stdout=False, upload_stderr=False)
...
def main():
    ...
    eval_log_dir = str(log_dir + "_eval")
